                ...
                sshagent(['ec2-ssh-key']) {
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no ec2-user@3.16.220.117 "
                            ...
                            ansible-playbook -i unified-inventory.ini node-exporter-playbook.yml
                            ansible-playbook -i unified-inventory.ini monitoring-playbook.yml
                        "
                    '''
                }
            }
